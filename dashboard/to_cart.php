...
if (!isset($_SESSION['user_id'])) {
    header('Location: ../account/index.php'); // Redirect ke login jika belum login
    exit();
}
...
if (mysqli_num_rows($result_cart) > 0) {
    ...
    $update = "UPDATE cart SET kuantitas = kuantitas + 1 WHERE user_id = $user_id AND product_id = $product_id";
    ...
    $insert = "INSERT INTO cart (user_id, product_id, kuantitas) VALUES ($user_id, $product_id, 1)";
